...
let GithubController = class GithubController {
    ...
    async createIssue(dto) {
        return this.githubService.criarIssue(dto.owner, dto.repo, dto.title, dto.body, dto.projectId);
    }
    async listarProjetos(login) {
        return this.githubService.listarProjetosV2(login);
    }
    async detalhesProjeto(projectId) {
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], GithubController.prototype, "listarProjetos", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], GithubController.prototype, "detalhesProjeto", null);
__decorate([
    (0, common_1.Get)('ratelimit'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], GithubController.prototype, "getRateLimit", null);
